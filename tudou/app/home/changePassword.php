        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-log-in"></span>&nbsp;change password</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action="/tudou/app/home/handler/changePassword.handler.php" method="post">
                        <fieldset>
                            <div class="form-group">
                                <label for="input_password"><span class="glyphicon glyphicon-lock"></span>&nbsp;your new password</label>
                            ...
                            <button type="submit" class="btn btn-lg btn-success btn-block">edit password</button>
                        </fieldset>
                    </form>
                </div>
            </div>
